...
def register_extracted_dataset(
    ml_client,
    custom_output_path: str,
    tags: dict
) -> RegisterExtractedDataset | None:
    ...
    extracted_images_dataset_name = "degradai-extracted"
    try:
        ...
        print("No dataset with name degradai-extracted")
    ...
    if not hash_tag_already_exists and "git_head_ref" in tags:  # and tags["git_head_ref"] == "main":
        extracted_images_dataset = Data(
            ...
            description="Extracted images for degradai",
        ...
        return RegisterExtractedDataset(
